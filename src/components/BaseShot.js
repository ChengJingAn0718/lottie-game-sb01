...
import { letterTurnList } from "./CommonVariants"
import { setLoop, initialAudio, currentSceneNumber } from "./CommonFunctions";
...
let objAudio1 = loadSound("word/" + letterTurnList[currentSceneNumber] + '/1')  //word voice
let objAudio2 = loadSound("word/" + letterTurnList[currentSceneNumber] + '/2')  //word voice
let objAudio3 = loadSound("word/" + letterTurnList[currentSceneNumber] + '/3')  //word voice

let reviewAudio1 = loadSound("summary/" + letterTurnList[currentSceneNumber] + '/1')  //word voice
let reviewAudio2 = loadSound("summary/" + letterTurnList[currentSceneNumber] + '/2')  //word voice
let reviewAudio3 = loadSound("summary/" + letterTurnList[currentSceneNumber] + '/3')  //word voice
...
let reviewAudio = loadSound('woo', true)
...
// let tapAudio = loadSound(letterTurnList[currentSceneNumber] + '/sb01_' + tapPathList[currentSceneNumber])  //word voice
...
let audioList = {
    ...
    welldoneAudio, reviewAudio,
    reviewAudio1, reviewAudio2,
    reviewAudio3,
    tapAudio, spakleAudio,
    objAudio1, objAudio2, objAudio3, excellentAudio
}

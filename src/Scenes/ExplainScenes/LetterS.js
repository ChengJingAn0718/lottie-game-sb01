...
export default React.forwardRef(function LetterExplain({ nextFunc, audioList, _geo, _baseGeo }, ref) {
    ...
    useEffect(
        () => {
            ...
            audioList.bodyAudio2.src = prePathUrl() + "sounds/conversation/s_g.mp3"
            audioList.bodyAudio1.src = prePathUrl() + "sounds/conversation/s_b.mp3"
    ...
    React.useImperativeHandle(ref, () => ({
        playGame: () => {
            ...
            timerList[2] = setTimeout(() => {
                ...
                backgroundRef.current.style.transform = ' translate(-165%, 30%) scale(2.2)'
    ...
    return (
        <div className="aniObject">
            <div
                ...
                <BaseImage
                    scale={0.1}
                    posInfo={{ l: 1.21, b: 0.5 }}
                    url={"sb01/sb01_fg/sb01_fg_sun.svg"}
                />
            </div>
        </div>
    );
